...
<head>
    ...
    {/if}
    <link href="design/{$settings->theme|escape}/css/jquery-ui.css" rel="stylesheet" type="text/css" media="screen"/>
	...
	{/literal}
    <script type="text/javascript" src="design/{$settings->theme}/js/jq_cookie.js"></script>
	{literal}
    <script>
...
<div class="foterr">
	<div id="top_background">
        {if $city != 'Not found'}
        <span class="geo"><label style="color:#999;">город:</label> <noindex><span style="color:333; cursor:pointer; text-decoration:underline;" rel="nofollow,noindex" href="#">{$city}</span></noindex></span>
        {else}
        <span class="geo"><label style="color:#999;">город:</label> <noindex><span style="color:333; cursor:pointer; text-decoration:underline;" rel="nofollow,noindex" href="#">город не найден</span></noindex></span>
        {/if}    
	<div id="top">
	    <div id="logo">
   ...
   <div class="clear" style="height:15px;"></div>
    ...
    {/if}
        ...
        <div class="filter_br"></div>
            ...
            <div id="blog_menu">
                {if $fromc}<div>
                {foreach $fromc as $gop}
                <span class="mi">{$gop->min}</span> - 
                <span class="ma">{$gop->max}</span>
                {/foreach}
                </div>{/if}            
        ...
        <div class="filter_br"></div>	
            ...
            <a rel="nofollow" href="{url params=[$ro->id=>null, page=>null]}" {if !$smarty.get.$ro@key}class="selected"{/if} class="all" style="padding-left:11px; font-weight:normal; float:right; color:#656565; text-decoration:underline;">все</a>
            </h2>
            <div class="clear"></div>
