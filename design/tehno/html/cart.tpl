...
<ul id="deliveries">
	...
	<li>
		<div class="checkbox">
			...
			<h3  id="productName" class="productGeneral">
...
{/if}
    <div class="information"><h2>Адрес получателя</h2></div>


<div class="alert forward">* Обязательная Информация</div>
<br class="clearBoth" />
	...
	{/if}
	<h3  id="productName" class="productGeneral"><label class="inputLabel">Имя, фамилия</label>
	<input name="name" type="text" value="{$name|escape}" data-format=".+" data-notice="Введите имя"/></h3>

	<h3  id="productName" class="productGeneral"><label class="inputLabel">Email</label>
	<input name="email" type="text" value="{$email|escape}" data-format="email" data-notice="Введите email" /></h3>

	<h3  id="productName" class="productGeneral"><label class="inputLabel">Телефон</label>
	<input name="phone" type="text" value="{$phone|escape}" /></h3>

	<h3  id="productName" class="productGeneral"><label class="inputLabel">Адрес доставки</label>
	<input name="address" type="text" value="{$address|escape}"/></h3>

	<h3  id="productName" class="productGeneral"><label class="inputLabel">Комментарий к&nbsp;заказу</label>
	<textarea name="comment" id="order_comment">{$comment|escape}</textarea></h3>
