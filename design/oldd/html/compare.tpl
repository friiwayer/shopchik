...
<tr class="hideable">
   <td align="center" valign="top" style="padding:20px; border: 0; " width="300">
         ...
         <a href="/"><img border='0' src="design/{$settings->theme|escape}/images/logo.png" title="{$settings->site_name|escape}" alt="{$settings->site_name|escape}"/></a>
...
<td valign="bottom" align="left" class="">
		...
		<form class="variants" action="/cart" target="_blank">
            ...
            {if $variant[0]->price > 0}<div style="padding: 15px"><input type="submit" class="button" value="в корзину" data-result-text="добавлено"/></div>{/if}
		</form>
...
<td {if $i.diff}class='diff'{/if}>{$k|escape}</td>
