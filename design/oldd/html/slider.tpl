...
<div class="flexslider">
	<ul class="slides">
		<li>
			<a href="/catalog/mobilnye-telefony"><img src="design/{$settings->theme|escape}/images/slider1.jpg" /></a>
		</li>
		<li>
			<a href="#"><img src="design/{$settings->theme|escape}/images/slider2.jpg" /></a>
		</li>
		<li>
			<a href="/catalog/planshety-netbuki"><img src="design/{$settings->theme|escape}/images/slider3.jpg" /></a>
		</li>
	</ul>
</div>
<!-- end -->