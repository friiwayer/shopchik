...
<ul class="shop4">
	...
	<li class="product">
		...
		{if $product->image}
		<div class="image">
			<a href="products/{$product->url}"><img src="{$product->image->filename|resize:140:140}" alt="{$product->name|escape}" title="купить {$product->name|escape}"/></a>
		</div>
		{/if}
...
{* Тело страницы *}
{$page->body}
<div><p>На все товары мы осуществляем Бесплатную Доставку в любой регион страны! <img src="design/{$settings->theme}/images/friishipping.png" width="100" /></p></div>
