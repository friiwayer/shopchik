...
<div class="product">
    ...
    <ul class="features">
    {foreach $product->hards as $hard}
    <li>
		<label>{$hard->name}</label>
		<span class="infa">{$hard->value}</span>
    </li>    
    {/foreach}
    </ul>
    {/if}
    ...
    <ul class="features">
    <h2>Мультимедия</h2>
    {foreach $product->multimedia as $n}
    <li>
		<label>{$n->name}</label>
		<span class="infa">{$n->value}</span>
    </li>    
    {/foreach}
    </ul>
    {/if}
    ...
    <ul class="features">
    <h2>Комплектация</h2>
    {foreach $product->compl as $c}
    <li>
		<label>{$c->name}</label>
		<span class="infa">{$c->value}</span>
    </li>    
    {/foreach}
    </ul>
    {/if}
