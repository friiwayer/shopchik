...
class IndexAdmin extends Simpla
{
	...
	public function __construct()
	{
		...
		$this->design->set_templates_dir('fetch/design/html');
		$this->design->set_compiled_dir('fetch/design/compiled');
		...
		if(empty($module) || !is_file('fetch/'.$module.'.php'))
			$module = 'ProductsAdmin';

		// Подключаем файл с необходимым модулем
		require_once('fetch/'.$module.'.php');  
