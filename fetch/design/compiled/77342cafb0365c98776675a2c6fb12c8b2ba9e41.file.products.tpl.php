<?php /* Smarty version Smarty-3.0.7, created on 2013-10-20 18:33:13
         compiled from "fetch/design/html\products.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14564526405c9763d54-65273343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '77342cafb0365c98776675a2c6fb12c8b2ba9e41' => 
    array (
      0 => 'fetch/design/html\\products.tpl',
      1 => 1382286786,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14564526405c9763d54-65273343',
  'function' => 
  array (
    'category_select' => 
    array (
...
<form method="get">
<div id="search">
    <label style="font-size:11px;">Поиск по названию товара</label>
...
<form method="get">
<div id="search">
    <label style="font-size:11px;">Поиск по Артикул товара</label>
	<input type="hidden" name="module" value="ProductsAdmin"/>
	<input class="search" type="text" name="articl" value="" />
	<input class="search_button" type="submit" value=""/>
</div>
</form>
...
<div id="header">	
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->getVariable('products_count')->value,'товар','товаров','товара');?>
		...
		<?php }elseif($_smarty_tpl->getVariable('article')->value){?>
			<h1><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->getVariable('products_count')->value,'Найден','Найдено','Найдено');?>
 <?php echo $_smarty_tpl->getVariable('products_count')->value;?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->getVariable('products_count')->value,'товар','товаров','товара');?>
</h1>
...
?>
				<li <?php if (!$_smarty_tpl->tpl_vars['variant']->first){?>class="variant" style="display:none;"<?php }?>>
                    <input class="dline" name="deadline[<?php echo $_smarty_tpl->getVariable('variant')->value->id;?>
]" type="checkbox" <?php if ($_smarty_tpl->getVariable('variant')->value->deadline){?>checked<?php }?> value="1"/>
...
$(function() {
    ...
    //дедлайн
	$("input.dline").click(function() {
		$(this).attr('checked', false);
        var id = line.find('input[type="checkbox"][name*="check"]').val();
		$.ajax({
			type: 'POST',
			url: 'ajax/update_object.php',
			data: {'object': 'deadline', 'id': id, 'variant': $(this).val()},
