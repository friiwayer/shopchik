<?php /* Smarty version Smarty-3.0.7, created on 2013-02-11 18:31:05
         compiled from "fetch/design/html\errorz.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2451551192ad9e59425-30253111%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5fe914a53e8df78684c27e081bcc6602d6cec257' => 
    array (
      0 => 'fetch/design/html\\errorz.tpl',
      1 => 1356506032,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2451551192ad9e59425-30253111',
  'function' => 
  array (
  ),
...
<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable('Обратная связь-рекомендации', null, 1);?>
<div id="header">
	<h1>Общие вопросы</h1>
</div>
<?php if ($_smarty_tpl->getVariable('rerrors')->value){?>
...
">
 ...
 $_from = $_smarty_tpl->getVariable('rerrors')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" />				
        ...
        <div class="cell"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'Shows','id'=>$_smarty_tpl->getVariable('as')->value->id,'return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
">@mail: <b><?php echo $_smarty_tpl->getVariable('as')->value->mail;?>
</b>
        </a> <?php echo $_smarty_tpl->getVariable('as')->value->date;?>
