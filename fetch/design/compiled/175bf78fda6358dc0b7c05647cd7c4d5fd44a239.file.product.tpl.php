<?php /* Smarty version Smarty-3.0.7, created on 2013-11-15 10:32:43
         compiled from "fetch/design/html\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:65875285ea3b513f78-02458817%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '175bf78fda6358dc0b7c05647cd7c4d5fd44a239' => 
    array (
      0 => 'fetch/design/html\\product.tpl',
      1 => 1384507961,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '65875285ea3b513f78-02458817',
  'function' => 
  array (
    'category_select' => 
    array (
...
if (!is_callable('smarty_modifier_truncate')) include 'Z:\home\localhost\www\shopchik\Smarty\libs\plugins\modifier.truncate.php';
?><?php ob_start(); ?>
...
$(function() {
    ...
    $("table.related_productz").sortable({ items: 'tr' , axis: 'y',  cancel: '#header', handle: '.move_zone' });
	...
	$('a.dele').live('click', function() {
        ...
        $(this).closest("div.row").find("input[name=deletz]").val($(this).closest("div.row").find("input[name=acc_id]").val());               
		return false;                
	});
    ...
    //Добавление гарнитуры
	var varint = $('#new_gar').clone(true);
	$('#new_gar').remove().removeAttr('id');
	$('#new_garz span.add').click(function() {
		if(!$('#new_garz').is('.single_variant'))
		{
			$(varint).clone(true).appendTo('#varint').fadeIn('slow');
		}
		else
		{
			$('#new_garz').show('slow');
			$('#new_garz').removeClass('single_variant');		
		}
		return false;		
	});	
	...
	$('.dline').datepicker();
    $('.dline').change(function(){
    var s = $(this).val().split("-");
    var liftoffTime = new Date();
    liftoffTime.setDate(liftoffTime.getDate());
    liftoffTime.getTimezoneOffset() * 60000;
    var hour = liftoffTime.getHours();
    $('.dline').datepicker( "option", "dateFormat","yy-mm-dd");
    $('.dline').val($(this).val() +'-'+ hour + "-00-00");
    });
...
"/> 
		...
		<div class="checkbox">
			<input name=showm value='1' type="checkbox" id="show_m_checkbox" class="<?php echo $_smarty_tpl->getVariable('product')->value->show_m;?>
" <?php if ($_smarty_tpl->getVariable('product')->value->show_m){?>checked<?php }?>/> <label for="show_m_checkbox">На главной</label>
		</div>        
	</div> 
...
?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('category')->value->name);?>
	...
	<div id="variants_block" <?php $_smarty_tpl->tpl_vars['first_variant'] = new Smarty_variable($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['first'][0][0]->first_modifier($_smarty_tpl->getVariable('product_variants')->value), null, null);?><?php if (count($_smarty_tpl->getVariable('product_variants')->value)<=1&&!$_smarty_tpl->getVariable('first_variant')->value->name){?>class=single_variant<?php }?>>
		<ul id="header">
            ...
            <li class="variant_ems" style="padding-right:25px;">EMS Доставка,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>	
			<li class="variant_discount">Старая, <?php echo $_smarty_tpl->getVariable('currency')->value->sign;?>
</li>	
			<li class="variant_amount">Кол-во</li>
            <li class="variant_deadline">DLine&nbsp;&nbsp;</li>
            <li class="variant_d_day">Срок</li>
            <li class="variant_dprice">Старая цена</li>
		</ul>
		<div id="variants">
...
" /></li>
            <li class="variant_ems">       <input name="variants[ems][<?php echo $_smarty_tpl->getVariable('variant')->value->id;?>
]"           type="text"   value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('variant')->value->ems);?>
" /></li>
...
<?php }?>" /><?php echo $_smarty_tpl->getVariable('settings')->value->units;?>
            ...
            <li class="variant_deadline">  <input name="variants[deadline][<?php echo $_smarty_tpl->getVariable('variant')->value->id;?>
]"      value="<?php echo $_smarty_tpl->getVariable('variant')->value->deadline;?>
"  class="oni"     type="text" size="1" <?php if ($_smarty_tpl->getVariable('variant')->value->deadline){?>checked<?php }?> /></li>
            <li class="variant_d_day"> <input name="variants[d_day][<?php echo $_smarty_tpl->getVariable('variant')->value->id;?>
]"         type="text"   value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('variant')->value->d_day);?>
"  class="dline" size="10"  /></li>
            <li class="variant_dprice"> <input name="variants[dprice][<?php echo $_smarty_tpl->getVariable('variant')->value->id;?>
]"         type="text"   value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('variant')->value->dprice);?>
"  class="" size="10"  /></li>
...
" /></li>
                <li><label class=property>Код на видео с YouTube</label><input name="youtube" class="simpla_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->youtube);?>
" /></li>
                <li><label class=property>Ссылка на поставщика(заказ)</label><textarea name="postav" class="simpla_inp" /><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->postav);?>
</textarea></li>
                ...
                <li><label class=property>Ссылка на товар: </label><a href="<?php echo $_smarty_tpl->getVariable('product')->value->postav;?>
" target="_blank"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->name);?>
</a></li>
			</ul>
		</div>
